...
libraries = ['clang_rt.builtins-x86_64.lib']
...
def buil_all():
    ...
    ext_modules_all = [
        ...
        Extension("miasm2.jitter.arch.JitCore_x86",
                  jit_base_files + ["miasm2/jitter/arch/JitCore_x86.c"]),
        Extension("miasm2.jitter.arch.JitCore_arm",
                  jit_base_files + ["miasm2/jitter/arch/JitCore_arm.c"]),
        Extension("miasm2.jitter.arch.JitCore_aarch64",
                  jit_base_files + ["miasm2/jitter/arch/JitCore_aarch64.c"]),
        Extension("miasm2.jitter.arch.JitCore_msp430",
                  jit_base_files + ["miasm2/jitter/arch/JitCore_msp430.c"]),
        Extension("miasm2.jitter.arch.JitCore_mep",
                  jit_base_files + ["miasm2/jitter/arch/JitCore_mep.c"]),
        Extension("miasm2.jitter.arch.JitCore_mips32",
                  jit_base_files + ["miasm2/jitter/arch/JitCore_mips32.c"]),
        Extension("miasm2.jitter.arch.JitCore_ppc32",
                  jit_base_files + ["miasm2/jitter/arch/JitCore_ppc32.c"],
