...
#from miasm.arch.arm.sem import Lifter_Armb, Lifter_M68k, Lifter_Armtl, Lifter_Armtb, cond_dct_inv, tab_cond
...
log = logging.getLogger('jit_m68k')
...
class jitter_m68k(Jitter):
    C_Gen = arm_CGen

    def __init__(self, loc_db, *args, **kwargs):
        lifter = LifterM68k(loc_db, 32)

        Jitter.__init__(self, lifter, *args, **kwargs)
