...
@pytest.mark.parametrize("type_id,type_desc", viewitems(types_mngr.types_ast._types))
def test_types(type_id, type_desc):
    print(type_id)
...
@pytest.mark.parametrize("type_id,type_desc", viewitems(types_mngr.types_ast._typedefs))
def test_typedefs(type_id, type_desc):
    print(type_id)
    obj = types_mngr.get_objc(type_id)
    print(obj)
    print(repr(obj))
...
def test_recurse():
    ...
    set_test = {obj_recurse, obj_recurse_bis}
